...
#include "PDC/Core/DynamicParticle.hh"
...
namespace utilities {
  ...
  void ThreeBodyDecay(ublas::vector<double>& velocity, PDS::core::DynamicParticle* finalState1, PDS::core::DynamicParticle* finalState2, PDS::core::DynamicParticle* finalState3, ublas::vector<double>& dir2, double Q) {
  ...
  void TwoBodyDecay(ublas::vector<double>& velocity, PDS::core::DynamicParticle* finalState1, PDS::core::DynamicParticle* finalState2, double Q) {
    ublas::vector<double> momentum1 (4);
    ublas::vector<double> momentum2 (4);

    ublas::vector<double> dir = RandomDirection();
